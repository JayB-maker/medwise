...
const MotorPolicyTable = (props: TableProps) => {
  const {
    arrange,
    data,
    paging,
  ...
  const tableColumnData = [
    ...
    },
    {
      ...
      render: (rowData: any) => (
        <div style={{ fontWeight: "600" }}>
          <p>{dateHandler(rowData.dateRegistered)}</p>
        </div>
      ),
    },
    // {
...
export default MotorPolicyTable;
